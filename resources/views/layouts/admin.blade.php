            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.index') }}">Beranda Admin</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('forums.adminIndex') }}">Forum Admin</a>
                        </li>
                    </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="text-start">
                                <p>Alamat Kantor: Jl. Pelindung</p>
                                <p>No. 123, Malang, Indonesia</p>
                            </div>
                            <ul class="nav fs-2">
